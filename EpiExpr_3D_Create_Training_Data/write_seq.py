...
##============
## Generate reference genome and resolution specific interval files, separately for each ** autosomal ** chromosomes.
## Note: we have considered output CAGE resolution (similar to FitHiChIP track resolution): default 4096bp
...
def parse_options():  
   ...
   parser.add_option('-r', 
                     ...
                     default=4096, 
                     type='int', 
                     help='Loop resolution. Default 4096bp (4 Kb)')
...
def main():
   ...
   ## infer intervals from the chromosome size information file
   ## use bedtools routine to create the bin interval file
   ## extract the chromosome size file only for the current chromosome
   ...
   ## now extract the intervals of the current chromosome
   ## with respect to the input loop resolution
   ## using the bedtools makewindows routine
