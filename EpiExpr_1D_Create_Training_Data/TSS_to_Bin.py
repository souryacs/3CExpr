...
## Objective: 
## 1. check reference genome specific TSS Annotations, 
## 2. For each CAGE bin, get the number of TSS, TSS sites (and corresponding genes)
...
def main():
    ...
    ## contains the following subset of fields 
    ## extracted from the original reference genome specific GTF file
    ...
    ## only these genes will be used for training and testing the model
    ##============
    ...
    ##================
    ## data frame for individual CAGE bins
    ## fields: chr, bin_start, bin_end, numTSS, TSS_index_vec
    ## numTSS = number of TSS falling in that bin 
    ...
    ## Example: 
    ## numTSS = 2 and TSS_index_vec = 1042,1055 
    ## -------- means that the 1042th and 1055th entry of the protein coding gene TSS file falls within the particular bin
    ##================
